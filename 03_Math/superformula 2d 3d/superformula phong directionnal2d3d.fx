...
float4x4 TT1 <String uiname="transform grid position before formula2d";>;
float4x4 TT <String uiname="transform grid position before formula3d";>;
...
//and as input data with the PS fu nction
...
float m2d  <String uiname="wave amount 2d";>  = 1;
float n12d <String uiname="effect1 2d";>  = 1;
float n22d <String uiname="effect2 2d";>  = 1;
float n32d <String uiname="effect3 2d";>  = 1;



float m  <String uiname="wave amount 3dx";>  = 1;
float n1 <String uiname="effect1 3dx";>  = 1;
float n2 <String uiname="effect2 3dx";>  = 1;
float n3 <String uiname="effect3 3dx";>  = 1;

float mb  <String uiname="wave amount 3dy";>  = 1;;
float n1b <String uiname="effect1 3dy";>  = 1;
float n2b <String uiname="effect2 3dy";>  = 1;
float n3b <String uiname="effect3 3dy";>  = 1;
    ...
    float4 TexCd : TEXCOORD0)
{
    ...
    PosBiTan supa2d = sfs3D(m2d , n12d , n22d , n32d ,m2d , n12d , n22d , n32d , PosO.x, PosO.y);
    PosO.xy = supa2d.Pos.xy;
      PosO = mul(PosO, TT);
