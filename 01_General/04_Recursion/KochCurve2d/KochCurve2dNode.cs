...
{
	#region PluginInfo
	[PluginInfo(Name = "KochCurve", Category = "2d", Tags = "fractal, recursion")]
	#endregion PluginInfo
	public class KochCurve2dNode : IPluginEvaluate
	{
		#region fields & pins
		[Input("Input", DefaultValues = new double[] {0.0,0.0})]
		public IDiffSpread<Vector2D> FInput;
		
		[Input("Iterations", DefaultValue = 1, MinValue = 1, IsSingle = true)]
